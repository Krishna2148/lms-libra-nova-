  ...
  ({ className, sticky, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-layout="header"
        className={cn(
          `z-10 flex h-[var(--header-height)] items-center gap-4 bg-transparent p-4 md:px-8`,
          contextVal.offset > 10 && sticky ? "shadow-sm" : "shadow-none",
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <ScrollArea className=" h-[calc(100vh_-_60px)] w-full" type="auto">
      <div
        ref={ref}
        data-layout="body"
        className={cn(
